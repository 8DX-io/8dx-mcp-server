...
function createMarketSwapScenarioPrompt(
  ...
  return [
    ...
    "1. WalletConnect-first and enabled by default: call eightdx_get_wallet_session and eightdx_walletconnect_get_session.",
    ...
    "14. If WalletConnect is unavailable in the current host, say direct wallet confirmation is unavailable there and offer walletLinks.metamaskMobileDappUrl/webUrl or routeLink.url as fallback web handoff links.",
