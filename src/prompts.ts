...
function createMarketSwapScenarioPrompt(
  ...
  return [
    ...
    "3. If amount, chain, slippage, or deadline are missing, ask for them. Use a default chain only after explicit user acceptance; use conservative slippage or deadline defaults only after telling the user.",
